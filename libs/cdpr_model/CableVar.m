...
%       P be a platform point.
    properties
        ...
        pos_PD_glob;%is a vector(size[3,1],[m]), containing the components of the position vector (D-P), projected on the global frame.
        pos_OD_glob;%is a vector(size[3,1],[m]), containing the components of the position vector (D-O), projected on the global frame.
        ...
        geometric_jacobian_l_col;%
        analitic_jacobian_l_col;%
        geometric_jacobian_s_col;%
        analitic_jacobian_s_col;%
        ...
        geometric_jacobian_l_col_d;%
        analitic_jacobian_l_col_d;%
        geometric_jacobian_s_col_d;%
        analitic_jacobian_s_col_d;%
        geometric_jacobian_p_col_d;%
        analitic_jacobian_p_col_d;%
