...
%CDPRVAR is a class containing time dependent variables of the cdpr.
  ...
  properties
    ...
    geometric_jacobian_l;%
    analitic_jacobian_l;%
    geometric_jacobian_s;%
    analitic_jacobian_s;%
    geometric_jacobian_p;%
    analitic_jacobian_p;%
    
    geometric_jacobian_l_d;%
    analitic_jacobian_l_d;%
  ...
  methods
    ...
    function obj = UpdateJacobians(obj)
      for i=1:length(obj.cable)
        obj.geometric_jacobian_l(:,i) = obj.cable(i).geometric_jacobian_l_col;
        obj.analitic_jacobian_l(:,i) = obj.cable(i).analitic_jacobian_l_col;
        obj.geometric_jacobian_s(:,i) = obj.cable(i).geometric_jacobian_s_col;
        obj.analitic_jacobian_s(:,i) = obj.cable(i).analitic_jacobian_s_col;
        obj.geometric_jacobian_p(:,i) = obj.cable(i).geometric_jacobian_p_col;
        obj.analitic_jacobian_p(:,i) = obj.cable(i).analitic_jacobian_p_col;
