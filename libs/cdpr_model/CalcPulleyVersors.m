function cable_v = CalcPulleyVersors(vers_i_loc,vers_j_loc,cable_v)
...
cable_v.vers_u = vers_i_loc*cos_s + vers_j_loc*sin_s;
cable_v.vers_w = -vers_i_loc*sin_s + vers_j_loc*cos_s;
