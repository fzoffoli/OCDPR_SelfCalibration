function cable_v = CalcCableVectors(sw_r,vers_k_loc,cable_v,rot_mat)
...
cable_v.vers_n = cable_v.vers_u*cos_p + vers_k_loc*sin_p;
cable_v.vers_t = cable_v.vers_u*sin_p - vers_k_loc*cos_p;
cable_v.pos_BA_glob = cable_v.pos_DA_glob - sw_r*(rot_mat*cable_v.vers_u+rot_mat*cable_v.vers_n);
