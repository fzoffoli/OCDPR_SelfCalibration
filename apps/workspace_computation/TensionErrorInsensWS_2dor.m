...
%reflect the soft-case scenario described in the paper Hybrid-Control-Based
%Workspace Analysis of Overconstrained Cable-Driven Parallel Robots.
...
function teiw = TensionErrorInsensWS_2dor(cdpr_p,ws_info,tau_p,tauP_dl,J_ort,dJ_ort,delta_tau_c,delta_l)
...
N=J_ort+dJ_ort;
fp=tau_p+tauP_dl*delta_l+J_ort*delta_tau_c;
