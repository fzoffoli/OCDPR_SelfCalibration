function [X_real, delta_length_meas, delta_sigma_meas, delta_psi_meas, phi_meas, theta_meas] = ControlSimShortLengthSwivelAHRS(cdpr_v,cdpr_p,Z_ideal,k,control_disturb,sensor_disturb)
...
delta_length_meas = sensor_disturb.length_noise*ones(size(delta_length_opt_meas))+delta_length_opt_meas;
