function [X_real, delta_sigma_meas, delta_psi_meas, phi_meas, theta_meas] = ControlSimShortSwivelAHRS(cdpr_v,cdpr_p,Z_ideal,k,control_disturb,sensor_disturb,scale_factor)
