function [X_real, loadcell_meas, delta_length_meas, delta_sigma_meas, delta_psi_meas, phi_meas, theta_meas] = ControlSimShortLengthLoadcellSwivelAHRS(cdpr_v,cdpr_p,Z_ideal,k,control_disturb,sensor_disturb,scale_factor)
